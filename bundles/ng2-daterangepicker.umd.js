(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ng2-daterangepicker'] = {}, global.ng.core, null, global.$));
}(this, (function (exports, i0, daterangepicker, $) { 'use strict';
    ...
    DaterangepickerConfig.ɵprov = i0.ɵɵdefineInjectable({ factory: function DaterangepickerConfig_Factory() { return new DaterangepickerConfig(); }, token: DaterangepickerConfig, providedIn: "root" });
    ...
    ***************************************************************************** */
    ...
    var DaterangepickerComponent = /** @class */ (function () {
        function DaterangepickerComponent(input, config, differs) {
            ...
            this.cancelDaterangepicker = new i0.EventEmitter();
            this.applyDaterangepicker = new i0.EventEmitter();
            this.hideCalendarDaterangepicker = new i0.EventEmitter();
            this.showCalendarDaterangepicker = new i0.EventEmitter();
            this.hideDaterangepicker = new i0.EventEmitter();
            this.showDaterangepicker = new i0.EventEmitter();
        ...
        DaterangepickerComponent.prototype.render = function () {
            ...
            $__default['default'](this.input.nativeElement).daterangepicker(this.targetOptions, this.callback.bind(this));
            if (this.options.customClasses && this.options.customClasses.length) {
                try {
                    for (var _b = __values(this.options.customClasses), _c = _b.next(); !_c.done; _c = _b.next()) {
                        ...
                        this.datePicker = $__default['default'](this.input.nativeElement).data('daterangepicker').container.addClass(customClass);
                    }
                }
                ...
                this.datePicker = $__default['default'](this.input.nativeElement).data('daterangepicker');
            }
        };
        ...
        DaterangepickerComponent.prototype.destroyPicker = function () {
            try {
                $__default['default'](this.input.nativeElement).data('daterangepicker').remove();
            }
            catch (e) {
        ...
        DaterangepickerComponent.prototype.attachEvents = function () {
            var _this = this;
            $__default['default'](this.input.nativeElement).on('cancel.daterangepicker', function (e, picker) {
                var event = { event: e, picker: picker };
                _this.cancelDaterangepicker.emit(event);
            });
            $__default['default'](this.input.nativeElement).on('apply.daterangepicker', function (e, picker) {
                var event = { event: e, picker: picker };
                _this.applyDaterangepicker.emit(event);
            });
            $__default['default'](this.input.nativeElement).on('hideCalendar.daterangepicker', function (e, picker) {
                var event = { event: e, picker: picker };
                _this.hideCalendarDaterangepicker.emit(event);
            });
            $__default['default'](this.input.nativeElement).on('showCalendar.daterangepicker', function (e, picker) {
                var event = { event: e, picker: picker };
                _this.showCalendarDaterangepicker.emit(event);
            });
            $__default['default'](this.input.nativeElement).on('hide.daterangepicker', function (e, picker) {
                var event = { event: e, picker: picker };
                _this.hideDaterangepicker.emit(event);
            });
            $__default['default'](this.input.nativeElement).on('show.daterangepicker', function (e, picker) {
                var event = { event: e, picker: picker };
    ...
    DaterangepickerComponent.propDecorators = {
        ...
        cancelDaterangepicker: [{ type: i0.Output }],
        applyDaterangepicker: [{ type: i0.Output }],
        hideCalendarDaterangepicker: [{ type: i0.Output }],
        showCalendarDaterangepicker: [{ type: i0.Output }],
        hideDaterangepicker: [{ type: i0.Output }],
        showDaterangepicker: [{ type: i0.Output }]
    };
